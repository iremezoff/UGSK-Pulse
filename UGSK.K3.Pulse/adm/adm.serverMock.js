...
(function () {
	...
	.run(function ($httpBackend) {
		var indexes = [{ Id: 1, Product: 'uauto', Value: 100, ActiveStart: new Date("2015-04-01"), IndexKind: 1 }];	    
		...
		var counters = [{ Product: 'uauto', PeriodKind: 1, Value: 112, CounterKind: 0, PeriodStart: new Date('2015-04-02'), IsClosed: false }];

		$httpBackend.whenGET("/api/Counter/").respond(counters);
